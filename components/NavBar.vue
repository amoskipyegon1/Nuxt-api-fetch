...
<template>
    <nav class="w-full fixed top-6 md:top-8 rounded-3xl flex flex-row items-center px-4 md:px-8 lg:px-12 xl:px-28 z-40">
        <div
        ...
        >
            <div class="w-full flex flex-row items-center justify-between">
                <NuxtLink to="/" class="flex flex-row items-center gap-x-2.5">
                    <div class="w-12 h-8 relative flex items-center justify-center -ml-4">
                        <IconsLogo />
                    </div>
                    <span class="text-lg font-semibold tracking-wide uppercase text-neutral-800 flex flex-row"
